...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  moonfly = {
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/moonfly",
  ...
  rainbow_csv = {
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/rainbow_csv",
