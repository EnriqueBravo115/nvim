...
_G.packer_plugins = {
  ...
  ["cellular-automaton.nvim"] = {
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/cellular-automaton.nvim",
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  gruvbox = {
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/gruvbox",
    url = "https://github.com/morhetz/gruvbox"
  },
  ["gruvbox-material"] = {
    loaded = true,
    path = "/home/nullboy/.local/share/nvim/site/pack/packer/start/gruvbox-material",
